...
axb.fill([0.942, 0.942, 0.989, 0.989], [0.636, 0.054, 0.054, 0.636], "#6630b2"; lw=0, alpha=0.2)
axb.fill([0.013, 0.013, 0.079, 0.079], [0.630, 0.054, 0.054, 0.630], "#66a7e6"; lw=0, alpha=0.3)
...
ax0.text(0.778, 0.167, "\$-60\$ m"; ha="center", va="center")
